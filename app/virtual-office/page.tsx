...
export default function VirtualOfficePage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="bg-white pt-32 pb-7">
        <div className="max-w-[1280px] mx-auto px-8">
          <div className="flex items-start gap-12">
            {/* Left Column - Heading and Search */}
            <div className="flex flex-col gap-6 max-w-[600px]">
              <h1 className="text-[36px] leading-[44px] font-normal tracking-[-0.72px]">
              ...
              {/* Search Bar */}
              <div className="flex items-start gap-[18.5px]">
                <div className="flex flex-col gap-[6.379px] w-[556px]">
                  <div className="flex items-center gap-[8.505px] h-[101px] px-[14.883px] py-[12.757px] rounded-[8.505px] border border-gray-300 bg-white shadow-shadows-shadow-xs">
                    <svg width="23" height="23" viewBox="0 0 23 23" fill="none" className="w-[21.262px] h-[21.262px]">
                    ...
                    <input
                      ...
                      className="flex-1 text-[30px] leading-[38px] font-medium text-gray-500 outline-none placeholder:text-gray-500"
                    />
                  </div>
                </div>
                <button className="h-[101px] px-[18px] py-3 flex items-center justify-center gap-[6px] rounded-lg border-2 border-white/12 bg-[#36BFFA] shadow-[0_0_0_1px_rgba(10,13,18,0.18)_inset,0_-2px_0_0_rgba(10,13,18,0.05)_inset,0_1px_2px_0_rgba(10,13,18,0.05)]">
            ...
            <div className="flex flex-col items-start gap-3 max-w-[480px] pt-2">
              <div className="flex items-center gap-[6px] rounded-lg py-3">
              ...
              {FEATURES.map((feature, index) => (
                <div key={index} className="flex items-start gap-3">
                  ...
                  <div className="flex flex-col items-start pt-[2px] w-[356px]">
                    <span className="text-gray-600 text-lg leading-7">{feature}</span>
                  </div>
                </div>
              ))}
            </div>
