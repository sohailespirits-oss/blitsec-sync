...
export default function Breadcrumb({ stateLabel, cityLabel }: BreadcrumbProps) {
  return (
    <div className="flex flex-row items-left gap-[6px]">
      ...
      {/* Static "Locations" */}
      <span className="font-inter font-semibold text-[14px] leading-[100%] text-[#717680]">
        Locations
      </span>
      ...
      {/* State */}
      <span className="font-inter font-semibold text-[14px] leading-[100%] text-[#026AA2] capitalize">
        {stateLabel}
      </span>
