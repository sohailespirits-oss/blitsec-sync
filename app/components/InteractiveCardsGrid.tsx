...
export function InteractiveCardsGrid({ interactiveCards, onDemoClick }: InteractiveCardsGridProps) {
  ...
  return (
    <div className="flex flex-col items-start justify-center gap-2 w-full lg:h-[152px] mt-[12px] lg:mt-[40px]">
      ...
      <div
        className="sm:hidden w-full lg:px-4 pt-[8px] px-[16px] sm:px-6 md:px-8 mx-auto max-w-[1280px] flex flex-col items-center gap-3"
      ...
      >
        ...
        <p className="font-semibold hidden sm:block text-gray-600 text-center">
          Click to view demo
        </p>
      </div>
