        ...
        <div className="flex w-full flex-1 flex-col items-start gap-1.5">
          <div className="relative w-full">
            ...
            <input
              ...
              className="w-full h-[48px] pl-[42px] pr-[14px] py-[12px] rounded-[8px] border border-[#D0D5DD] bg-white text-[#475467] placeholder:text-[#667085] focus:outline-none focus:border-[#36BFFA] focus:border-transparent shadow-[0px_1px_2px_0px_#1018280D]"
            />
          </div>
        </div>
        <button
